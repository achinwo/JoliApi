...
public struct PlayState: Persisted, DataConvertible {
    ...
    public init(createdAt: Date, createdById: Int?, deletedAt: Date?, deletedById: Int?, id: Int, progressMs: Int, refreshToken: String, state: String, stateChangedAt: Date, trackUri: String, updatedAt: Date, updatedById: Int?) {
        self.createdAt = createdAt
        self.createdById = createdById
        self.deletedAt = deletedAt
        self.deletedById = deletedById
